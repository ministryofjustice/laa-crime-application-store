class PaymentRequestResource
  ...
  attributes :id, :submitter_id, :request_type,
             :submitted_at, :submission_id, :date_claim_assessed, :calculation_method
  attributes :claimed_profit_cost, :allowed_profit_cost,
             ...
             if: proc { |payment_request, _attrs| payment_request.payable_claim.is_a? NsmClaim }
  ...
  one :payable_claim, resource: lambda { |resource|
