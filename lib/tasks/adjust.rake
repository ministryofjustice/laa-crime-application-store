...
namespace :adjust do
  ...
  task fix_draft_updated_at: :environment do
    # ID's taken from adjust_fix_status file in https://dsdmoj.atlassian.net/wiki/spaces/CRM457/pages/5088936016/Team+metrics+data+issues#Error---Count-not-matching
    ids = [
