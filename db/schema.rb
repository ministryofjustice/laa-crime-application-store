...
ActiveRecord::Schema[7.2].define(version: 2024_10_31_152111) do
  ...
  create_table "application_version", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
    t.virtual "search_fields", type: :tsvector, as: "((((((((((((((setweight(to_tsvector('simple'::regconfig, COALESCE(((application -> 'defendant'::text) ->> 'first_name'::text), ''::text)), 'B'::\"char\") || setweight(to_tsvector('simple'::regconfig, split_part(COALESCE(((application -> 'defendant'::text) ->> 'first_name'::text), ''::text), '/'::text, 1)), 'B'::\"char\")) || setweight(to_tsvector('simple'::regconfig, split_part(COALESCE(((application -> 'defendant'::text) ->> 'first_name'::text), ''::text), '/'::text, 2)), 'B'::\"char\")) || setweight(to_tsvector('simple'::regconfig, COALESCE(((application -> 'defendant'::text) ->> 'last_name'::text), ''::text)), 'B'::\"char\")) || setweight(to_tsvector('simple'::regconfig, split_part(COALESCE(((application -> 'defendant'::text) ->> 'last_name'::text), ''::text), '/'::text, 1)), 'B'::\"char\")) || setweight(to_tsvector('simple'::regconfig, split_part(COALESCE(((application -> 'defendant'::text) ->> 'last_name'::text), ''::text), '/'::text, 2)), 'B'::\"char\")) || setweight(to_tsvector('simple'::regconfig, jsonb_path_query_array(application, '$.\"defendants\"[*].\"first_name\"'::jsonpath)), 'B'::\"char\")) || setweight(to_tsvector('simple'::regconfig, split_part((jsonb_path_query_array(application, '$.\"defendants\"[*].\"first_name\"'::jsonpath))::text, '/'::text, 1)), 'B'::\"char\")) || setweight(to_tsvector('simple'::regconfig, split_part((jsonb_path_query_array(application, '$.\"defendants\"[*].\"first_name\"'::jsonpath))::text, '/'::text, 2)), 'B'::\"char\")) || setweight(to_tsvector('simple'::regconfig, jsonb_path_query_array(application, '$.\"defendants\"[*].\"last_name\"'::jsonpath)), 'B'::\"char\")) || setweight(to_tsvector('simple'::regconfig, split_part((jsonb_path_query_array(application, '$.\"defendants\"[*].\"last_name\"'::jsonpath))::text, '/'::text, 1)), 'B'::\"char\")) || setweight(to_tsvector('simple'::regconfig, split_part((jsonb_path_query_array(application, '$.\"defendants\"[*].\"last_name\"'::jsonpath))::text, '/'::text, 2)), 'B'::\"char\")) || setweight(to_tsvector('simple'::regconfig, COALESCE(((application -> 'firm_office'::text) ->> 'name'::text), ''::text)), 'B'::\"char\")) || setweight(to_tsvector('simple'::regconfig, COALESCE((application ->> 'ufn'::text), ''::text)), 'A'::\"char\")) || setweight(to_tsvector('simple'::regconfig, lower(COALESCE((application ->> 'laa_reference'::text), ''::text))), 'A'::\"char\"))", stored: true
