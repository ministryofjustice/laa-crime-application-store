...
ActiveRecord::Base.transaction do
  ...
  nsm3 = NsmClaim.create!(laa_reference: "LAA-0003", ufn: "123458/103", solicitor_office_code: "2B456C", stage_code: "PROG", client_first_name: "Carla", client_last_name: "Carter")
  PaymentRequest.create!(submitter_id: SecureRandom.uuid, request_type: "non_standard_mag_appeal", submitted_at: 20.days.ago, date_received: nsm3.date_received, payment_request_claim: nsm3,
  ...
  nsm4 = NsmClaim.create!(laa_reference: "LAA-0004", ufn: "123459/104", solicitor_office_code: "2B456C", stage_code: "PROM", client_first_name: "Diego",  client_last_name: "Diaz")
  PaymentRequest.create!(submitter_id: SecureRandom.uuid, request_type: "non_standard_mag_amendment", submitted_at: 18.days.ago, date_received: nsm4.date_received, payment_request_claim: nsm4,
  ...
  nsm5 = NsmClaim.create!(laa_reference: "LAA-0005", ufn: "123460/105", solicitor_office_code: "3C789D", stage_code: "PROG", client_first_name: "Erin",   client_last_name: "Evans")
  PaymentRequest.create!(submitter_id: SecureRandom.uuid, request_type: "non_standard_mag_supplemental", submitted_at: 16.days.ago, date_received: nsm5.date_received, payment_request_claim: nsm5,
  ...
  nsm7 = NsmClaim.create!(laa_reference: "LAA-0007", ufn: "123462/107", solicitor_office_code: "1A123B", stage_code: "PROG", client_first_name: "Greg",   client_last_name: "Garcia")
  PaymentRequest.create!(submitter_id: SecureRandom.uuid, request_type: "non_standard_mag_appeal", submitted_at: 13.days.ago, date_received: nsm7.date_received, payment_request_claim: nsm7,
  ...
  nsm8 = NsmClaim.create!(laa_reference: "LAA-0008", ufn: "123463/108", solicitor_office_code: "2B456C", stage_code: "PROM", client_first_name: "Hiren",  client_last_name: "Hughes")
  PaymentRequest.create!(submitter_id: SecureRandom.uuid, request_type: "non_standard_mag_amendment", submitted_at: 12.days.ago, date_received: nsm8.date_received, payment_request_claim: nsm8,
  ...
  nsm10 = NsmClaim.create!(laa_reference: "LAA-0010", ufn: "123465/110", solicitor_office_code: "4D012E", stage_code: "PROM", client_first_name: "Jamie", client_last_name: "Jones")
  PaymentRequest.create!(submitter_id: SecureRandom.uuid, request_type: "non_standard_mag_supplemental", submitted_at: 10.days.ago, date_received: nsm10.date_received, payment_request_claim: nsm10,
  ...
  nsm11 = NsmClaim.create!(laa_reference: "LAA-0011", ufn: "123466/111", solicitor_office_code: "5E345F", stage_code: "PROG", client_first_name: "Kira",  client_last_name: "Khan")
  PaymentRequest.create!(submitter_id: SecureRandom.uuid, request_type: "non_standard_mag_appeal", submitted_at: 9.days.ago, date_received: nsm11.date_received, payment_request_claim: nsm11,
  ...
  # --------------------------------
  ac1 = AssignedCounselClaim.create!(laa_reference: "LAA-1001", ufn: "223456/201", counsel_office_code: "AB180F", solicitor_office_code: "4D012E", stage_code: "PROG", client_first_name: "Maya",   client_last_name: "Murray")
  PaymentRequest.create!(submitter_id: SecureRandom.uuid, request_type: "assigned_counsel", submitted_at: 7.days.ago, date_received: ac1.date_received, payment_request_claim: ac1,
  ...
  ac2 = AssignedCounselClaim.create!(laa_reference: "LAA-1002", ufn: "223457/202", counsel_office_code: "AB180F", solicitor_office_code: "4D012E", stage_code: "PROM", client_first_name: "Noah",   client_last_name: "Novak")
  PaymentRequest.create!(submitter_id: SecureRandom.uuid, request_type: "assigned_counsel_appeal", submitted_at: 6.days.ago, date_received: ac2.date_received, payment_request_claim: ac2,
  ...
  ac3 = AssignedCounselClaim.create!(laa_reference: "LAA-1003", ufn: "223458/203", counsel_office_code: "AB180F", solicitor_office_code: "5E345F", stage_code: "PROG", client_first_name: "Omar",   client_last_name: "Oneill")
  PaymentRequest.create!(submitter_id: SecureRandom.uuid, request_type: "assigned_counsel_amendment", submitted_at: 5.days.ago, date_received: ac3.date_received, payment_request_claim: ac3,
  ...
  ac4 = AssignedCounselClaim.create!(laa_reference: "LAA-1004", ufn: "223459/204", counsel_office_code: "AB180F", solicitor_office_code: "5E345F", stage_code: "PROM", client_first_name: "Priya",  client_last_name: "Patel")
  PaymentRequest.create!(submitter_id: SecureRandom.uuid, request_type: "assigned_counsel", submitted_at: 4.days.ago, date_received: ac4.date_received, payment_request_claim: ac4,
  ...
  ac5 = AssignedCounselClaim.create!(laa_reference: "LAA-1005", ufn: "223460/205", counsel_office_code: "AB180F", solicitor_office_code: "1A123B", stage_code: "PROG", client_first_name: "Quinn",  client_last_name: "Quinn")
  PaymentRequest.create!(submitter_id: SecureRandom.uuid, request_type: "assigned_counsel_appeal", submitted_at: 3.days.ago, date_received: ac5.date_received, payment_request_claim: ac5,
  ...
  ac6 = AssignedCounselClaim.create!(laa_reference: "LAA-1006", ufn: "223461/206", counsel_office_code: "AB180F", solicitor_office_code: "2B456C", stage_code: "PROM", client_first_name: "Rosa",   client_last_name: "Reid")
  PaymentRequest.create!(submitter_id: SecureRandom.uuid, request_type: "assigned_counsel_amendment", submitted_at: 2.days.ago, date_received: ac6.date_received, payment_request_claim: ac6,
  ...
  ac7 = AssignedCounselClaim.create!(laa_reference: "LAA-1007", ufn: "223462/207", counsel_office_code: "GE251B", solicitor_office_code: "3C789D", stage_code: "PROG", client_first_name: "Sam",    client_last_name: "Singh")
  PaymentRequest.create!(submitter_id: SecureRandom.uuid, request_type: "assigned_counsel", submitted_at: 2.days.ago, date_received: ac7.date_received, payment_request_claim: ac7,
  ...
  ac8 = AssignedCounselClaim.create!(laa_reference: "LAA-1008", ufn: "223463/208", counsel_office_code: "GE251B", solicitor_office_code: "4D012E", stage_code: "PROM", client_first_name: "Tara",   client_last_name: "Turner")
  PaymentRequest.create!(submitter_id: SecureRandom.uuid, request_type: "assigned_counsel", submitted_at: 1.day.ago, date_received: ac8.date_received, payment_request_claim: ac8,
