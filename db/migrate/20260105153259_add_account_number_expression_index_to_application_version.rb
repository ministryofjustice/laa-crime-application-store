class AddAccountNumberExpressionIndexToApplicationVersion < ActiveRecord::Migration[8.1]
  disable_ddl_transaction! #allows concurrently

  INDEX_NAME = "idx_application_version_on_account_number"
  ...
  def up
    ...
    execute <<~SQL
      ...
      ON application_version (
        (application -> 'firm_office' ->> 'account_number')
      );
    SQL
  end
