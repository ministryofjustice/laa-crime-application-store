...
RSpec.describe "adjust:fix_expired" do
  ...
  it "Processes as expected" do
    ...
    expect(klass.where(to_status: 'expired').pluck(:id, :processing_seconds)).to eq(
      [
        ["14994bfc-95c2-4ddb-94a0-1b84cbc1f7f0", 1249625.179],
        ["73c46945-0a6c-4b3a-a828-661de16edd79", 1243270.139],
        ["bd080793-01d5-4882-9b42-360f123ec8b7", 1235002.357],
        ["fcc2f94e-a2bd-422e-b59a-53210fa52bd5", 1244228.889]
      ]
    )
  end
end